...
[CustomEditor(typeof(PlayablesPrototypeV2Controller))]
public class PlayablesPrototypeV2ControllerEditor : Editor
{

    PlayablesPrototypeV2Controller m_Target;

    // Override OnInsepctorGUI() to draw your own editor
    public override void OnInspectorGUI()
    {
        m_Target = (PlayablesPrototypeV2Controller)target;
